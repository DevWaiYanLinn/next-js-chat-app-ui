          ...
          <div className='flex flex-col h-full space-y-3'>
            <div className='bg-white rounded-md p-3 flex items-center justify-between'>
              <div className='flex justify-center items-center space-x-2'>
                <Image src={faker.image.avatarLegacy()} className='rounded-full' alt="avtar" width={40} height={40} />
            ...
            <div className='p-2 rounded-md bg-white'>
              <div className='flex justify-between items-center'>
                ...
                <div className='flex-grow text-sm ml-2 focus:outline-none  max-h-[150px] break-words overflow-y-scroll scroll-hide' contentEditable={true} placeholder='Start typing here...'></div>
